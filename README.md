# A Sprite only release of the main ALttPO desgined for racing or information co-op

find the main project here: https://github.com/alttpo/alttpo

The rest is a copy of the README from the main project.
